    ...
    <BrochureLayout>
      ...
      <BrochureContent className="page-assessments" title={page.get('brochureTitle')}>
              ...
              <div className="page-assessments__course">
                ...
                <div className="content">
                  ...
                  <button
                    ...
                    onClick={clickAction(actions.modalOpen, 'assessment', {id: course.get('assessmentCode')})}
                  >
                    Take Assessment
                  </button>
                </div>
        ...
        <blockquote className="page-assessments__testimonial">
          <p>
            When I started a new job as a Data Visualization Analyst, I thought I had the skills to hit the ground running. However, I quickly
            realized that I would need to up my game if I was going to be successful.
          </p>
          <p>
            After completing the Excel and Power BI paths from Maven Analytics, I went from barely being able to keep up to getting callouts from VPs
            for how great my dashboards look!
          </p>
