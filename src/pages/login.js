  ...
  return (
    <Auth>
      <form onSubmit={onSubmit}>
        <div className="form-group">
          <label htmlFor="email">Email address</label>
          <input ref={register} disabled={isSubmitting} type="text" name="email" id="email" className="input" required/>
        </div>
        <div className="form-group">
          <label htmlFor="password">Password</label>
          <input ref={register} disabled={isSubmitting} type="password" name="password" id="password" className="input" required/>
        </div>
        {error ? (
          <div className="form-message">
